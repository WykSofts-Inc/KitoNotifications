# Contributing to KitoNotifications
...
3. Make your change. Follow
   [KitoNotifications's engineering standards](https://github.com/WykSofts-Inc/KitoNotifications/blob/main/docs/ENGINEERING_STANDARDS.md) —
